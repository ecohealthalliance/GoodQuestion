...
const KeyboardAvoidingView = React.createClass({
  ...
  componentWillMount() {
    if (Platform.OS === 'ios') {
      this.subscriptions = [
        DeviceEventEmitter.addListener('keyboardWillChangeFrame', this.onKeyboardChange),
      ];
    } else {
      this.subscriptions = [
        DeviceEventEmitter.addListener('keyboardDidHide', this.onKeyboardChange),
        DeviceEventEmitter.addListener('keyboardDidShow', this.onKeyboardChange),
      ];
    }
  },
  ...
  render() {
    ...
    switch (behavior) {
      case 'height':
        ...
        return (
          <View {...props} style={[this.props.style, heightStyle]}>
            {children}
          </View>
        );
      ...
      case 'position':
        ...
        return (
          <View {...props} style={[this.props.style, positionStyle]}>
              {children}
          </View>
      ...
      case 'padding':
        ...
        return (
          <View {...props} style={[this.props.style, paddingStyle]}>
            {children}
          </View>
        );
